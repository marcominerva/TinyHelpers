...
A Int32 representing the number of elements that meet the criteria defined by the *predicate* function, if not `null`; the number of elements in *source*, otherwise.
